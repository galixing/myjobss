    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=250, verbose_name='职位名称')),
                ('salary', models.CharField(blank=True, default='6000', max_length=64, verbose_name='薪资待遇')),
                ('job_num', models.IntegerField(default=1, verbose_name='招聘数量')),
